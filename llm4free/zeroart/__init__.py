...
FontType = Literal[
    "block", "slant", "neon", "cyber", "dotted", "shadow", "3d", "electronic", "isometric"
]
...
def glitch(
    text: str, font: Union[str, ZeroArtFont] = "block", glitch_intensity: float = 0.1
) -> str:
    """
...
def gradient(
    text: str,
    font: Union[str, ZeroArtFont] = "block",
