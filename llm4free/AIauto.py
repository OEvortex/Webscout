...
an available LLM provider from the llm4free library that doesn't require
API keys or cookies.
"""
...
from llm4free.AIbase import Provider, Response, ResponseType
from llm4free.exceptions import AllProvidersFailure
...
class AUTO(Provider):
    ...
    LLM provider from the llm4free library.
