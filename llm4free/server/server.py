"""
LLM4Free OpenAI-Compatible API Server
...
def create_app():
    ...
    # Simple Custom Swagger UI with LLM4Free footer
...
def main():
    """Main entry point for the llm4free-server console script."""
    import argparse
    ...
    parser = argparse.ArgumentParser(description="Start LLM4Free OpenAI-compatible API server")
    parser.add_argument(
        "--port",
        type=int,
