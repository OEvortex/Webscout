"""
Opera Aria provider for webscout.
...
xtekky/gpt4free's ``g4f/Provider/OperaAria.py`` and rewritten in webscout's
...
webscout targets. Add it back if a future TTI provider needs it.
"""
...
class OperaAriaConversation:
    ...
    webscout ``Provider`` instance without the g4f JsonConversation
    machinery.
    """
...
class OperaAria(Provider):
    """Sync webscout provider for Opera Aria.
