...
Wraps :class:`webscout.Provider.OllamaSwarm` (the regular webscout
...
from webscout.Provider.OllamaSwarm import (
...
from webscout.Provider.Openai_comp.OperaAria import _approx_tokens  # ty:ignore[import-not-found]
...
class OllamaSwarm(OpenAICompatibleProvider):
    ...
    def __init__(
        ...
        # the helpers from webscout/Provider/OllamaSwarm.py so both
